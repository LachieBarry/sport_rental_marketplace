...
listing1 = Listing.new(
  ...
  address: Faker::Address.street_address, # Ensure this is a valid address
  latitude: Faker::Address.latitude, # Ensure this is a valid latitude
  longitude: Faker::Address.longitude # Ensure this is a valid longitude
)
